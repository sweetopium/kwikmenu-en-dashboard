    ...
    def _build_prompt(
        ...
        *,
        ...
        lines = [
            ...
            "Example: 'Espresso' + '35 ml | $3.50' must become name='Espresso', measureValue=35, measureUnit='ml', price='3.50'.",
            "Example: 'House White Wine' + '150 ml | $9' must become measureValue=150, measureUnit='ml', price='9'.",
