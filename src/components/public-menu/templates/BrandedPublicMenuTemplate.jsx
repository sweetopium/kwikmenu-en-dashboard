          ...
          <div className="relative z-[1] mt-24">
            ...
            {venueDescription ? (
              <button
                ...
                className="mt-3 max-w-[330px] text-left text-sm leading-relaxed text-white/75 line-clamp-3 hover:text-white transition-colors active:opacity-80 block"
              >
                {venueDescription}
              </button>
            ) : null}
